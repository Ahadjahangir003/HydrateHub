...
const ChangePass = () => {
    ...
    const handleGoBack = () => {
        navigate('/user-profile'); // Navigate back to user profile
    };
    ...
    return (
        <div className="bg-gray-100 h-full pt-1 flex flex-col items-center justify-center">
            ...
            <div className="my-3 bg-gradient-to-r from-blue-500 to-indigo-300 p-10 rounded-lg shadow-lg w-9/12 self-center">
